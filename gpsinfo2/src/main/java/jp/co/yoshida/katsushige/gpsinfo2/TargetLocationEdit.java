...
public class TargetLocationEdit extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_taget_location_edit);
        ylib = new YLib(this);
